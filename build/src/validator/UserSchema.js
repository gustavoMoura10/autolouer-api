...
var createSchema = joi_1.default.object({
    ...
    document: joi_1.default.string()
        ...
        var validate = (0, validateCPFCNPJ_1.default)(value);
        if (!validate) {
    ...
    passwordConfirmation: joi_1.default.string().equal(joi_1.default.ref("password")).required(),
    birthdate: joi_1.default.date(),
});
var UserSchema = (function () {
    function UserSchema() {
    }
    UserSchema.prototype.create = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, createSchema.validateAsync(body)];
                    case 1:
                        _a.sent();
                        return [3, 3];
                    case 2:
